...
<body>
	<div class="page">
		<div class="header"><img src="../images/cobec-header.jpg" width="960" height="180" href="../index.php" /></div>
		<div class="columns">
		  <div class="content">
		  <?php include("form-win2014.html"); ?>	 
		  </div>
			<div class="left sidebar">
				<?php include("../includes/navigation.html"); ?>
	</div>
		   			<div class="footer">
			<?php include("../includes/footer.html"); ?></div>
		</div><!-- end of columns-->
    </div><!-- end of page-->
</body>
